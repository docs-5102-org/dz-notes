---
title: Vercel部署`VuePress Theme Hope`
category:
  - vue
tags:
  - Vercel
...
![](file/QQ_1757744989249.png)

#### 选择github已存在的项目

![](file/QQ_1757745079646.png)

#### 部署项目

需要配置一下，构建`VuePress Theme Hope` 命令，这里已经包含官方提供的默认的`.github\workflows\deploy-docs.yml`工作流

![](file/QQ_1757745155836.png)

#### 配置自定义域名

点击 Domains

![](file/QQ_1757745256310.png)
点击Add Domain，这里可以通过CF来代理当前的域名
![](file/QQ_1757745284574.png)