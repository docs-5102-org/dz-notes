  ...
  return (
    <div id="top" className="min-h-screen bg-fd-background text-fd-foreground">
      <section className="relative overflow-hidden pb-24 pt-8">
        <div className="absolute left-[-8rem] top-[-6rem] h-72 w-72 rounded-full bg-fd-primary/12 blur-3xl" />
        <div className="absolute right-[-6rem] top-4 h-80 w-80 rounded-full bg-amber-400/10 blur-3xl dark:bg-fd-primary/10" />
        <div className="absolute inset-x-0 top-0 h-[560px] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--color-fd-card)_90%,transparent)_0%,color-mix(in_srgb,var(--color-fd-popover)_72%,transparent)_56%,transparent_100%)]" />
